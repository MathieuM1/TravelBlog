 ...
 */
class Categories extends \AppBundle\Entity\Categories implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Categories' . "\0" . 'articles', '' . "\0" . 'AppBundle\\Entity\\Categories' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Categories' . "\0" . 'title'];
        }
